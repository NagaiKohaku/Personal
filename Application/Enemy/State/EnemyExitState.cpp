...
void EnemyExitState::Update(Enemy& enemy) {
	...
	//目標地点を計算
	Vector3 targetPos = EaseOut(enemy.GetExitStartPos(), enemy.GetExitPos(), ratio, 2.0f);
