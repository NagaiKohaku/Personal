...
private:
	...
	const MyEngine::Vector3 objectSize_ = { 1.0f,1.0f,1.0f };

	const float colliderSize_ = 1.0f;

	const float speed_ = 1.0f;

	const float lifeTime_ = 2.0f;

	const MyEngine::Collider::Tag colliderTag_ = MyEngine::Collider::Tag::PLAYERBULLETMEDIUM;
