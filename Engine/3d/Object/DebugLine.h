...
namespace MyEngine {
	...
	public:
		...
		void Initialize(DebugObjectCommon* debugObjectCommonPtr, Renderer* rendererPtr, Vector3 direction, Vector4 color);
		...
		/// <param name="color">ラインの描画色</param>
		void Initialize(DebugObjectCommon* debugObjectCommonPtr, Renderer* rendererPtr, Vector3 start, Vector3 end, Vector4 color);
