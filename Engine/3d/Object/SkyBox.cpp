...
namespace MyEngine {
	...
	/// スカイボックスを初期化
	///=====================================================///
	void SkyBox::Initialize(std::string filePath, Object3DCommon* object3DCommonPtr, SkyBoxCommon* skyBoxCommonPtr, Renderer* rendererPtr) {
	...
	void SkyBox::Draw() {
		...
		//コマンドをレンダラーに登録
		renderer_->AddDraw(LayerType::BACKGROUND, true, command);
	}
}